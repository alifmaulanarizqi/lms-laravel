                    ...
                    <form action="{{ route('admin.password.store') }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                ...
                                <span class="input-group-text toogle-password">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" class="form-control confirm-password" name="password_confirmation" required
                                    placeholder="Your password" autocomplete="current-password">
                                <span class="input-group-text toogle-confirm-password">
                                    <a href="javascript:;" class="link-secondary" title="Show password"
                                        data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"

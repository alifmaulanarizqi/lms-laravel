            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 wow fadeInRight">
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.information') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        ...
                                        <input type="text" name="headline" placeholder="Enter your headline" value="{{ auth()->user()->headline }}">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.password') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.social') }}" method="POST" class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        <label>Facebook</label>
                                        <input type="text" name="facebook" value="{{ auth()->user()->facebook }}" placeholder="Enter your Facebook link">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        <label>X</label>
                                        <input type="text" name="x" value="{{ auth()->user()->x }}" placeholder="Enter your X link">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        ...
                                        <input type="text" name="linkedin" value="{{ auth()->user()->linkedin }}" placeholder="Enter your LinkedIn link">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        <label>Website</label>
                                        <input type="text" name="website" value="{{ auth()->user()->website }}" placeholder="Enter your Website link">
                                ...
                                <div class="col-xl-12">
                                    <div class="wsus__dashboard_profile_update_info">
                                        <label>Github</label>
                                        <input type="text" name="github" value="{{ auth()->user()->github }}" placeholder="Enter your Github link">

            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 wow fadeInRight">
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.information') }}" method="POST"
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.password') }}" method="POST"
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form action="{{ route('student.profile.update.user.social') }}" method="POST"
                            class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
